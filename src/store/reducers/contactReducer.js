import {
  ...
  ACTION_CLEAR_CONTACT_EDIT, ACTION_SET_FILTER
} from '../actions/contact'

export const DEFAULT_CONTACT = { done: false, title: '' };
...
export default function contactReducer(state = initialState, { type, payload }) {
  switch (type) {
    ...
    case ACTION_CLEAR_CONTACT_EDIT: return { ...state, contactEdit: DEFAULT_CONTACT }
    case ACTION_SET_CONTACT_LIST: return { ...state, list: payload }
    case ACTION_SET_FILTER: return { ...state, filter: payload }
    case ACTION_CONTACT_UPDATE: return {
      ...state,
